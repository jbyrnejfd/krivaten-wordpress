<p class="social-icons">
	<?php 
		...
		if($urlFacebook != "") { 
			echo '<a href="'.kvt_add_http($urlFacebook).'" title="View Facebook Page" target="_blank"><i class="fa fa-facebook"></i></a>';
		}
		
		$urlTwitter = get_option("kvt_twitter_url");
		if($urlTwitter != "") { 
			echo '<a href="'.kvt_add_http($urlTwitter).'" title="View Twitter Page" target="_blank"><i class="fa fa-twitter"></i></a>';
		}
		...
		if($urlFeed != "") { 
			echo '<a href="'.kvt_add_http($urlFeed).'" title="View Feed Page" target="_blank"><i class="fa fa-rss"></i></a>';
		}
	?>
</p>